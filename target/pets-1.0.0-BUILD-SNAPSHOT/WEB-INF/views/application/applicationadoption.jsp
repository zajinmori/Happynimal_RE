...
<html lang="en">
    ...
    <form:form modelAttribute="application" action="${pageContext.request.contextPath}/submit" method="post">
        ...
        <form:radiobutton path="gender" cssClass="userans" type="radio" id="male" name="gender" value="M"> 남성
        <form:radiobutton path="gender" cssClass="userans" type="radio" id="female" name="gender" value="F"> 여성<br><br>
        ...
        <label class="adoptionquestion" for="maritalStatus">결혼을 하셨습니까?</label>
            <form:radiobutton path="maritalStatus" value="1" label="결혼함" cssClass="userans"/> 결혼함&nbsp;
            <form:radiobutton path="maritalStatus" value="0" label="결혼하지 않음" cssClass="userans"/> 결혼하지 않음
            ...
            <form:radiobutton path="q1" value="1" label="있음" cssClass="userans"/> 있음&nbsp;
            <form:radiobutton path="q1" value="0" label="없음" cssClass="userans"/> 없음
            ...
            <form:radiobutton path="q2" value="1" label="있음" cssClass="userans"/> 있음&nbsp;
            <form:radiobutton path="q2" value="0" label="없음" cssClass="userans"/> 없음
            ...
            <form:radiobutton path="q4" value="1" label="아파트" cssClass="userans"/> 아파트&nbsp;&nbsp;
            <form:radiobutton path="q4" value="2" label="단독주택" cssClass="userans"/> 단독주택&nbsp;&nbsp;
            <form:radiobutton path="q4" value="3" label="빌라/다세대" cssClass="userans"/> 빌라/다세대&nbsp;&nbsp;
            <form:radiobutton path="q4" value="4" label="원룸" cssClass="userans"/> 원룸
            <form:errors path="q4" cssClass="error"/>
            <br><br>

            <!-- 입양에 대한 가족들의 입장 -->
            <label class="adoptionquestion" for="q5">입양에 대한 가족들의 입장</label>
            <form:radiobutton path="q5" value="0" label="본인제외 모두반대" cssClass="userans"/> 본인제외 모두반대&nbsp;&nbsp;
            <form:radiobutton path="q5" value="1" label="부분 찬성" cssClass="userans"/> 부분 찬성&nbsp;&nbsp;
            <form:radiobutton path="q5" value="2" label="모두 찬성" cssClass="userans"/> 모두 찬성
            ...
            <form:radiobutton path="q7" value="1" label="예" cssClass="userans"/> 예&nbsp;
            <form:radiobutton path="q7" value="0" label="아니오" cssClass="userans"/> 아니오
            ...
            <form:radiobutton path="q11" value="1" label="예" cssClass="userans"/> 예&nbsp;
            <form:radiobutton path="q11" value="0" label="아니오" cssClass="userans"/> 아니오
            ...
            <form:radiobutton path="q12" value="1" label="예" cssClass="userans"/> 예&nbsp;
            <form:radiobutton path="q12" value="0" label="아니오" cssClass="userans"/> 아니오
